...
export default function Menu() {
    ...
    return (
        <div className="relative z-50 ml-4">
            ...
            >
                <span className={`w-[30px] h-[3px] bg-white rounded transition-transform duration-300 ease-in-out ${isOpen ? "translate-y-[8px] rotate-45" : ""}`}></span>
                <span className={`w-[30px] h-[3px] bg-white rounded transition-opacity duration-300 ease-in-out ${isOpen ? "opacity-0" : "opacity-100"}`}></span>
                <span className={`w-[30px] h-[3px] bg-white rounded transition-transform duration-300 ease-in-out ${isOpen ? "-translate-y-[8px] -rotate-45" : ""}`}></span>
            </button>
